        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <button
                    ...
                    onClick={() => router.visit(route("dashboard.coupons.create"))}
                >
                    Add New Coupon
                </button>
            </div>
                                    ...
                                    <td className="px-4 py-2">
                                        <label className="inline-flex items-center cursor-pointer">
                                            <input
                                                ...
                                                onChange={() =>
                                                    router.put(route("coupons.toggleStatus", coupon.id), {
                                                        preserveScroll: true,
                                                    })
                                                }
                                    ...
                                    <td className="px-4 py-2">
                                        <div className="flex space-x-2">
                                            ...
                                            <button
                                                ...
                                                onClick={() => router.delete(route("coupons.destroy", coupon.id))}
                                            >
                                                Delete
                                            </button>
                                        </div>
